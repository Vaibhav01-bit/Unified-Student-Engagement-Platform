    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex gap-2 p-1 bg-surface rounded-xl border border-surface-border w-fit">
        <button
          ...
          className={`px-5 py-2 rounded-lg text-sm font-semibold transition-all duration-200 ${activeTab === 'roi' ? 'bg-primary text-white shadow-lg shadow-primary/30' : 'text-muted hover:text-white'
            }`}
        >
          📈 ROI Calculator
        </button>
        <button
          ...
          className={`px-5 py-2 rounded-lg text-sm font-semibold transition-all duration-200 ${activeTab === 'loan' ? 'bg-primary text-white shadow-lg shadow-primary/30' : 'text-muted hover:text-white'
            }`}
        >
          🏦 Loan Eligibility
        </button>
            ...
            <div className="card space-y-5 animate-bounce-in">
              ...
              <div>
                ...
                <div className="w-full bg-surface rounded-full h-2.5 overflow-hidden">
                  <div
                    className={`h-2.5 rounded-full bg-gradient-to-r ${roiResult.breakEvenMonths <= 18 ? 'from-green-500 to-teal' :
              ...
              {/* Description */}
              <div className={`flex items-start gap-2 p-3 rounded-xl ${roiResult.verdict === 'Excellent' || roiResult.verdict === 'Good' ? 'bg-teal/10 border border-teal/20' :
          ...
          <div className="card space-y-5">
            ...
            <div className="space-y-3">
              ...
              <div
                ...
                className={`flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all duration-200 ${loanForm.coApplicant ? 'bg-primary/15 border-primary/40' : 'bg-surface border-surface-border hover:border-surface-border/80'
                  }`}
              ...
              >
                ...
                <div className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${loanForm.coApplicant ? 'bg-primary border-primary' : 'border-surface-border'
                  }`}>
              ...
              <div
                id="loan-collateral"
                className={`flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all duration-200 ${loanForm.collateral ? 'bg-teal/15 border-teal/40' : 'bg-surface border-surface-border hover:border-surface-border/80'
                  }`}
              ...
              >
                ...
                <div className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${loanForm.collateral ? 'bg-teal border-teal' : 'border-surface-border'
                  }`}>
          ...
          {loanResult ? (
            <div className="card space-y-5 animate-bounce-in">
              <div className="flex items-center justify-between">
                ...
                <span className={`badge border text-sm font-bold px-4 py-1.5 ${loanResult.tier === 'High' ? 'bg-green-500/20 border-green-500/40 text-green-400' :
